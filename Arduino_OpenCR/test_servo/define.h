...
#define HS422_CNT_SERVO_MIN 100     // Compteur minimum du PWM 12bit du PCA9865 pour le servomoteur HS422 (0°).
...
#define PCA9685_OSC_FREQ 25750000   // Fréquence d'oscillation du PCA9865 (Ajusté pour avoir une fréquence de 50Hz précisément).